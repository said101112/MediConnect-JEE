...
public class ConsultationService implements Serializable {
    ...
    /**
     * Ouvre une nouvelle consultation ou récupère celle existante pour un rendez-vous.
     */
    ...
    /**
     * Clôture la consultation, met à jour le RDV et génère la facture automatiquement.
     */
    public void cloturerConsultation(Consultation consultation) throws Exception {
        ...
        // Génération automatique de la facture pour la secrétaire
    ...
    /**
     * Génère un PDF stylisé pour l'ordonnance de la consultation.
     */
